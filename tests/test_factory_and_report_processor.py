...
def test_factory_create_a_and_b(monkeypatch):
    ...
    monkeypatch.setattr(factory_module, "PDFServiceA", lambda output_dir=None: "pdf-a")
    monkeypatch.setattr(factory_module, "PDFServiceB", lambda output_dir=None: "pdf-b")
